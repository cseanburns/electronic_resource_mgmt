...
That is, the following duties in these ads are mostly independent of the specific technologies used:
...
Website maintenance and deployment (see Fig 13), for example, completely dropped off the radar.
...
So we rely, in very important ways, and are more dependent on other actors in the publishing and e-resource provider ecosystem.
