...
would be one connected people from different silos
to each other and helping them communicate.
It turns out that,
...
That raises strategic and technical questions about today's role
...
fascinating area of librarianship.
...
In the first part,
we study the nature of the work itself:
...
1. How do we manage all of this electronic stuff? Not only
   ...
   on our patrons, but it involves all different sorts of
   librarians.
